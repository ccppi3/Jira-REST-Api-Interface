...
build-pyinstaller: refresh-version
	...
	pyinstaller .\gui.py --version-file exeVersionInfo.txt --windowed --noconfirm --name "jira-flow" --add-data "jira.ico;." --add-data ".env;." --add-data ".\TemplatePayload.json;." --add-data ".\help.txt;." --hiddenimport win32timezone --icon .\jira.ico --collect-all TkinterDnD2
...
build-pyinstaller-debug: refresh-version
	@echo "build using using pyinstaller"
	pyinstaller .\gui.py --version-file exeVersionInfo.txt --noconfirm --name "jira-flow" --add-data "jira.ico;." --add-data ".env;." --add-data ".\TemplatePayload.json;." --add-data ".\help.txt;." --hiddenimport win32timezone --icon .\jira.ico --collect-all TkinterDnD2
	@echo "to make an installer run make installer, this will generate a setup.exe in the directory Output"
	@echo "to make a zip run make zip"
zip:
