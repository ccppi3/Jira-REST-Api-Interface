...
build-debug:
	python -m nuitka --show-scons --show-memory --show-modules --verbose --clang -j 9 --debug --unstripped --standalone --windows-console-mode=force --enable-plugin=tk-inter --show-progress --devel-recompile-c-only .\gui.py 
